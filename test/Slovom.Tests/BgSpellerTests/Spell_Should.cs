...
namespace Slovom.Tests.BgSpellerTests
{
    public class Spell_Should
    {
        ...
        public void Spell_Positive_Numbers_Using_MaleGender_Correctly(long number, string result)
        {
            // Arrange
            var sut = new BgNumberSpeller();
        ...
        public void Spell_Negative_Numbers_Using_MaleGender_Correctly(long number, string result)
        {
            // Arrange
            var sut = new BgNumberSpeller();
        ...
        public void Spell_Negative_Numbers_Using_FemaleGender_Correctly(long number, string result)
        {
            // Arrange
            var sut = new BgNumberSpeller();
